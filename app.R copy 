   ...
   dashboardBody(
     tabItems(
       tabItem( tabName = "allAges",
                fluidRow(
                  box(plotOutput("plotAllAges"), width = 8
                  )
                )
              ),
       ...
       tabItem( tabName = "ages0", 
                fluidRow(
                  box(plotOutput("plotAges0"), width = 8
                  )
                )
              ),
       ...
       tabItem( tabName = "ages21", 
                fluidRow(
                  box(plotOutput("plotAges21"), width = 8 
                  )
                )
              ),
       ...
       tabItem( tabName = "ages35", 
                fluidRow(
                  box(plotOutput("plotAges35"), width = 8
                  )
                )
              ),
       ...
       tabItem( tabName = "ages55",
                fluidRow(
                  box(plotOutput("plotAges55"), width = 8
                  )
                )
              ),
